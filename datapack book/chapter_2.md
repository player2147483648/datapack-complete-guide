...
- `/tp <targets> <location> [<rotation>]` teleports all of the target entities to a specfic entity, with optional rotation data.
...
- `/tp 12 34 56` - teleports you to a random location;
...
- `/tp @s 230.23 20 168.95 90 0` - teleports you to a random position while making you look west, without looking up nor down (i.e completely forwards);
